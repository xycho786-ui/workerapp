      ...
      <main className="flex-1 overflow-y-auto px-5 pt-2 pb-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {!isSearching ? (
          ...
          <div className="space-y-8">
            ...
            <Link href="/customer/jobs" className="block bg-gradient-to-r from-primary to-[#F4978E] rounded-2xl p-4 flex items-center justify-between shadow-lg shadow-primary/25 active:scale-[0.98] transition-transform">
