...
const navRoutes = [
  { key: "home", href: "/worker/dashboard", icon: <Home className="w-6 h-6" /> },
  { key: "jobs", href: "/worker/jobs", icon: <Briefcase className="w-6 h-6" /> },
  { key: "chat", href: "/worker/chat", icon: <MessageSquare className="w-6 h-6" /> },
  { key: "alerts", href: "/worker/notifications", icon: <Bell className="w-6 h-6" /> },
  { key: "profile", href: "/worker/profile", icon: <User className="w-6 h-6" /> },
];
